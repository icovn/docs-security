...
cd nginx-1.12.2
./configure --prefix=/u01/applications/nginx-1.12.2 --with-http_ssl_module --add-module=../nginx-rtmp-module-1.2.1 --add-module=../nginx-module-vts-0.1.15 --with-http_stub_status_module --with-http_sub_module
make -j8
make install -j8
```
